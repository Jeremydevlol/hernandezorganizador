...
export const SHEET_CONFIG: Record<SheetType, {
    ...
    tratamientos: {
        ...
        columns: [
            { key: "num_orden_parcelas", label: "Id. Parcelas", width: 90 },
            { key: "cultivo_especie", label: "Cultivo", width: 120, editable: true },
            { key: "superficie_tratada", label: "Sup. Tratada", width: 90, type: "number", editable: true },
            { key: "fecha_aplicacion", label: "Fecha", width: 100, type: "date", editable: true },
            { key: "problema_fitosanitario", label: "Problema", width: 130, editable: true },
            { key: "aplicador", label: "Aplicador", width: 70, editable: true },
            { key: "equipo", label: "Equipo", width: 60, editable: true },
            { key: "productos_display", label: "Producto", width: 140 },
            { key: "dosis_display", label: "Dosis", width: 80 },
            { key: "eficacia", label: "Eficacia", width: 80 },
        ],
    },
    historico: {
